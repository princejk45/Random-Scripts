...
if (!defined('TD_THEME_VERSION')) {
    define('TD_THEME_VERSION', '1.0.0'); // Replace '1.0.0' with the actual theme version.
}
    ...
    for ( $i = 0; $i < count ( $content ); $i ++ ) {
        if ( $i == $paragraphAfter) {
            ...
            if (in_category('72')){ // Italia
                $new_content .= '<center><ins data-fluid-zoneid="17414" data-fluid-id="e6404a5432b1988ea2e71ec092e8608a"></ins>
                <script async src="//fluid.4strokemedia.com/www/fluid/player.php"></script></center>';
            }
            else if (in_category('77')){ //Calabria
                $new_content .= '<center><ins data-fluid-zoneid="17413" data-fluid-id="e6404a5432b1988ea2e71ec092e8608a"></ins>
                <script async src="//fluid.4strokemedia.com/www/fluid/player.php"></script></center>';
            }
            else if (in_category('103')){ //Provincia
                $new_content .= '<center><ins data-fluid-zoneid="17412" data-fluid-id="e6404a5432b1988ea2e71ec092e8608a"></ins>
                <script async src="//fluid.4strokemedia.com/www/fluid/player.php"></script></center>';
            }
            else if (in_category('66')){ //Area Urbana
                $new_content .= '<center><ins data-fluid-zoneid="17411" data-fluid-id="e6404a5432b1988ea2e71ec092e8608a"></ins>
                <script async src="//fluid.4strokemedia.com/www/fluid/player.php"></script></center>';
            }
            else{
                $new_content .= '<center><ins data-fluid-zoneid="8995" data-fluid-id="e6404a5432b1988ea2e71ec092e8608a"></ins>
                <script async src="//fluid.4strokemedia.com/www/fluid/player.php"></script></center>';
            }
            $new_content .= '</div>';
        }
